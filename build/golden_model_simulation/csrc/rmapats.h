...
extern "C" {
#endif
void  hs_0_M_0_21__simv_golden_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_0__simv_golden_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_1__simv_golden_daidir (UB  * pcode, scalar  val, U  I681, scalar  * I1312, U  did);
void  hs_0_M_0_2__simv_golden_daidir (UB  * pcode);
void  hs_0_M_0_11__simv_golden_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_21__simv_golden_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_0__simv_golden_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_1__simv_golden_daidir (UB  * pcode, scalar  val, U  I681, scalar  * I1312, U  did);
void  hs_0_M_1_2__simv_golden_daidir (UB  * pcode);
void  hs_0_M_1_11__simv_golden_daidir (UB  * pcode, scalar  val);
