...
create_analysis_view -name TT_VIEW -constraint_mode CONSTRAINTS -delay_corner TT_DELAY -latency_file ${::IMEX::dataVar}/mmmc/views/TT_VIEW/latency.sdc
create_analysis_view -name SS_SETUP_VIEW -constraint_mode CONSTRAINTS -delay_corner SS_DELAY -latency_file ${::IMEX::dataVar}/mmmc/views/SS_SETUP_VIEW/latency.sdc
create_analysis_view -name FF_HOLD_VIEW -constraint_mode CONSTRAINTS -delay_corner FF_DELAY -latency_file ${::IMEX::dataVar}/mmmc/views/FF_HOLD_VIEW/latency.sdc
