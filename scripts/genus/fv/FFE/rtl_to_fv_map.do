...
# Generated on: Wed Apr 15 16:11:45 PDT 2026 (Wed Apr 15 23:11:45 UTC 2026)
...
set logfile fv/FFE/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/FFE -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/share/instsww/cadence/GENUS231/tools.lnx86"
set CDN_SYNTH_ROOT      "/share/instsww/cadence/GENUS231/tools.lnx86"
set env(CW_DIR) "/share/instsww/cadence/GENUS231/tools.lnx86/lib/chipware"
set CW_DIR      "/share/instsww/cadence/GENUS231/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /share/instsww/cadence/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/share/instsww/cadence/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/share/instsww/cadence/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/share/instsww/cadence/GENUS231/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/share/instsww/cadence/GENUS231/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /scratch/eecs251b-aaj/Final_Project/tech/lib -library -both
read_library -liberty -both \
    /scratch/eecs251b-aaj/Final_Project/tech/lib/sky130_tt_1.8_25_nldm.lib
...
add_search_path /scratch/eecs251b-aaj/Final_Project/rtl/ffe -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /scratch/eecs251b-aaj/Final_Project/rtl/ffe/FFE.v
elaborate_design -golden -root {FFE} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/FFE/fv_map.v.gz
elaborate_design -revised -root {FFE}
...
set_analyze_option -mapping_file fv/FFE/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.FFE.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.FFE.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.FFE.rtl.fv_map.rpt
